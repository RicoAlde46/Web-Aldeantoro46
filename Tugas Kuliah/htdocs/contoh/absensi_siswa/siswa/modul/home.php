			...
			<div class="card full-height">
				<div class="card-body">
					<div class="card-title">
						<center>
							<img src="../assets/img/usd.png" width="100">
							<br>
							<b>Universitas Sanata Dharma</b>
						</center>
					</div>
					<div class="card-category">
						<center>
							Kampus III
							Jl. Paingan, Krodan, Maguwoharjo, Kec. Depok, Kabupaten Sleman, Daerah Istimewa Yogyakarta Kode Pos : 55281
							<br>Email : Humas@usd.ac.id (0274) 883037
						</center>
					</div>
					...
					<div class="tab-content mt-2 mb-3" id="pills-with-icon-tabContent">
						...
						<div class="tab-pane fade" id="pills-contact-icon" role="tabpanel" aria-labelledby="pills-contact-tab-icon">
							<p>
								...
								Aplikasi Presensi Mahasiswa ini dibuat untuk mendokumentasikan kehadiran Mahasiswa Aplikasi sangat mudah digunakan (Berbasis web)
							</p>
						</div>
					</div>
				</div>
