...
<head>
	...
	<title>Ketua Program Studi (KAPRODI) | Aplikasi Presensi</title>
			...
			<footer class="footer">
				<div class="container">
					<div class="copyright ml-auto">
						&copy; <?php echo date('Y'); ?> Presensi Mahasiswa Universitas Sanata Dharma (<a href="index.php">Carolus Rico Aldeantoro </a> | 2022)
					</div>
				</div>
			</footer>
		</div>
