					...
					<div class="form-group row">
						...
						<div class="col-sm-9">
							<div class="form-group clearfix">
								...
								<div class="icheck-primary d-inline">
									<input type="radio" class="statusbiaya" id="statusbiaya2" value="perpasang" name="statusbiaya">
									<label for="statusbiaya2">Per Pasang
									</label>
								</div>
								...
								<div class="icheck-primary d-inline">
									<input type="radio" class="statusbiaya" id="statusbiaya4" value="perpotong" name="statusbiaya">
									<label for="statusbiaya4">Per Potong
									</label>
								</div> -->
