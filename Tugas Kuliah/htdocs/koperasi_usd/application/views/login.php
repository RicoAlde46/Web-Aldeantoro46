...
<head>
	...
	<title>Login SD IT WASH</title>
	<link rel="shortcut icon" href="<?= base_url('assets/img/kopma.png'); ?>">
	...
	<style>
		body {
			...
			/* background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('assets/img/2.jpg'); */
		}
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12 col-sm-12 text-center mt-5 mb-3">
				...
				<h3 class="text-white mt-2">KOPERASI MAHASISWA UNIVERSITAS SANATA DHARMA</h3>
