					...
					<div class="form-group row">
						...
						<div class="col-sm-9">
							<div class="form-group clearfix">
								...
								<div class="icheck-primary d-inline">
									<input type="radio" class="jk" id="jk2" value="Perempuan" name="jk">
									<label for="jk2">Perempuan
									</label>
								</div>
								<!-- <div class="icheck-primary d-inline">
									<input type="radio" class="jk" id="jk3" value="Tidak disebutkan" name="jk">
									<label for="jk3">Tidak disebutkan
									</label> -->
							</div>
						</div>
					</div>
					...
					foreach ($data as $item) : ?>
						<tr>
							...
							<td>
								...
								<div class="tombol">
									<bottom class="btn btn-default" id="ubahPelanggan" data-kd_pelanggan="<?= $item->kd_pelanggan ?>" data-nama="<?= $item->nama ?>" data-no_hp="<?= $item->no_hp ?>" data-jk="<?= $item->jk ?>" data-alamat="<?= $item->alamat ?>">
										<ion-icon name="create-outline"></ion-icon>
									</bottom>
									<bottom class="btn btn-danger hapuspelanggan" data-url="<?= base_url() . 'admin/pelanggan/hapus/' . $item->kd_pelanggan ?>">
