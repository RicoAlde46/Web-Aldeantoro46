...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 30 Nov 2022 pada 16.50
...
INSERT INTO `detail_pesanan` (`Id_pesanan`, `Id_barangCucian`, `Jumlah_item`, `Harga_transaksi`) VALUES
(1, 1, '1', '25000'),
(2, 2, '1', '20000'),
(3, 3, '1', '30000'),
(4, 4, '1', '25000'),
...
(1, 'Kartono', 'Jalan Setan', '081097568934'),
(2, 'Eko', 'Jalan Pocong', '085212123445'),
(3, 'Eka', 'Jalan Kunti', '082111234567'),
(4, 'Bambang', 'Jalan Terbaik', '083123345534'),
(5, 'Heli', 'Jalan Susah', '087773245024');
...
INSERT INTO `penyedia_jasa` (`Id_penyediaJasa`, `Nama_penyediaJasa`, `Alamat`, `Telepon`, `Email_laundry`, `Rating`) VALUES
(1, 'SD_IT Wash', 'Jl.Sempu I, Pucanganom, Wedomartanai, Ngemplak, Sleman, Yogyakarta.', ' 08109756893', '', '5/5');
