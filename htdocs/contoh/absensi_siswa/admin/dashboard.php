		...
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="blue">
				...
				<a href="dashboard.php" class="logo">
					...
					<b class="text-white">Universitas Sanata Dharma</b>
				</a>
						...
						<li class="nav-item">
							...
							<div class="collapse" id="base">
								<ul class="nav nav-collapse">
									...
									<li>
										<a href="?page=walas">
											<span class="sub-item"> Dosen Pembimbing Akademik </span>
										</a>
									</li>
								...
								<ul class="nav nav-collapse">
									<li>
										<a href="?page=kepsek&act=add ">
											<span class="sub-item"> Tambah Ketua Program Studi </span>
										</a>
									</li>
									<li>
										<a href="?page=kepsek">
											<span class="sub-item"> Daftar Ketua Program Studi </span>
										</a>
									</li>
								</ul>
							</div>
			...
			<footer class="footer">
				<div class="container">
					<div class="copyright ml-auto">
						&copy; <?php echo date('Y'); ?> Presensi Universitas Sanata Dharma (<a href="index.php">Carolus Rico Aldeantoro </a> | 2022)
					</div>
				</div>
			</footer>
		</div>
