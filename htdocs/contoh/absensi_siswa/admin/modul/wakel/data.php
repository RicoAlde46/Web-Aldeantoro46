<div class="page-inner">
    <div class="page-header">
        <h4 class="page-title">Dosen Pembimbing Akademik</h4>
        <ul class="breadcrumbs">
            ...
            <li class="nav-item">
                <a href="#">Dosen Pembimbing Akademik</a>
            </li>
            <li class="separator">
                <i class="flaticon-right-arrow"></i>
            </li>
            <li class="nav-item">
                <a href="#">Daftar Dosen Pembimbing Akademik</a>
            </li>
        </ul>
    </div>
    <div class="row">
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h4 id="exampleModalLabel" class="modal-title">Edit Dosen Pembimbing Akademik</h4>
