                        ...
                        <div class="page-inner py-5">
                            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                                <div>
                                    ...
                                    <h5 class="text-white op-7 mb-2">Aplikasi Presensi Berbasis Web</h5>
                                </div>
    ...
    <footer class="footer">
        <div class="container">
            <div class="copyright ml-auto">
                &copy; <?php echo date('Y'); ?> Presensi Mahasiswa Universitas Sanata Dharma (<a href="index.php">Carolus Rico Aldeantoro</a>
                | 2022)
            </div>
        </div>
    </footer>
